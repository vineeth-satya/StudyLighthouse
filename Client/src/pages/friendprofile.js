...
export default function Friendprofile() {
    return (
      <div className="bg-black text-white p-6 rounded-lg w-full h-screen flex flex-col items-start justify-start pt-32">
        <Header />
        <div className="w-full">
          <h2 className="text-3xl font-bold text-left mb-4 ml-6">Study_Buddy's Profile</h2>
          ...
          <div className="mb-4 pt-4 ml-10 text-xl">
          ...
          <div>
            <h3 className="font-bold mb-2 text-xl ml-10">Solved Problems:</h3>
